...
const jwt_strategy_1 = require("./authenticationStrategies/jwt-strategy");
...
class ETenderingApplication extends boot_1.BootMixin(service_proxy_1.ServiceMixin(repository_1.RepositoryMixin(rest_1.RestApplication))) {
    constructor(options = {}) {
        super(options);
        this.setUpBindings();
...
exports.ETenderingApplication = ETenderingApplication;
