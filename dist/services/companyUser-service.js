...
let MyCompanyUserService = class MyCompanyUserService {
    constructor(companyUserRepository, foundUserClass) {
        this.companyUserRepository = companyUserRepository;
        this.foundUserClass = foundUserClass;
    }
    async verifyCredentials(credentials) {
        const invalidCredentialsError = 'Invalid email or password.';
        const foundUser = await this.companyUserRepository.findOne({
...
MyCompanyUserService = __decorate([
...
], MyCompanyUserService);
exports.MyCompanyUserService = MyCompanyUserService;
